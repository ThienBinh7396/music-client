...
export default {
    ...
    methods: {
        ...mapMutations('app', ['setAxiosInstance', 'setToken', 'setUser', 'setResponsive', 'setDetectMobile', 'setShowMusicBar', 'setSocket', 'setAlert']),
    ...
    created() {
        ...
        if (!this.user) {
            ...
            this.axiosInstance.post('/client/users/checkInfor', {
    ...
    mounted() {
        ...
        this.interval = setInterval(function () {
            that.instance.post('client/users/checkToken', {
                token: that.token,
        ...
        window.calculateTime = function (time) {
            ...
            if (diffSecond > 30 * 24 * 60 * 60) {
                text = `${parseInt(diffSecond /30 / 24/ 60 / 60)}m`;
            } else
            if (diffSecond > 24 * 60 * 60) {
    ...
    computed: {
        ...mapState('app', ['user', 'responsive', 'showMusicBar', 'token', 'socket', 'axiosInstance']),
